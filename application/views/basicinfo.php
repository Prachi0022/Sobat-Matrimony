									...
									<div class="edit-pro-parti">
										...
										<div class="row">
											<div class="col-3 form-group">
												...
												<select class="form-select chosen-select" name="day" id="day"
										...
										<div class="row">
											...
											<div class="col-md-6 form-group">
												...
												<select class="form-select chosen-select" name="weight" id="weight"
													required>
										...
										<div class="row">
											<div class="col-md-6 form-group">
												...
												<select class="form-select chosen-select" name="bgrp" id="bgrp"
													required>
											...
											<div class="col-6 form-group">
												...
												<input type="tel" class="form-control" name="number" pattern="[0-9]{10}+$"
													maxlength="13" placeholder="+91 " required>
											</div>
										</div>
									...
									<div class="edit-pro-parti">
										...
										<div class="row">
											<div class="col-4 form-group">
												...
												<select class="form-select chosen-select" name="religion" id="religion"
													required>
										...
										<div class="row">
											...
											<div class="col-md-6 form-group">
												...
												<select class="form-select chosen-select" name="preference" required>
													<option value="">Select</option>
													<option value="Same Caste">Same Caste</option>
													<option value="Open to Intercaste">Open to Intercaste Marriage
													</option>
												</select>
											</div>
										</div>
										<div class="row">
											<div class="col-6 form-group" id="total_children_div" style="display:none;">
												<label class="lb">Total Children:</label>
												<input type="number" class="form-control" name="total_children"
													id="total_children" min="0" placeholder="Enter total children">
											</div>

											<div class="col-6 form-group" id="children_status_div"
												style="display:none;">
												<label class="lb">Children Status:</label>
												<select class="form-select chosen-select" name="children_status"
													id="children_status">
										...
										<div class="row">
											<div class="col-md-12 form-group">
												<label class="lb">If the prospective partner is divorced or widowed,
													would you be comfortable if they have a child?</label>
												<select class="form-select chosen-select" name="child_acceptance"
													id="child_acceptance" required>
													<option value="">Select</option>
													<option value="Yes">Yes</option>
													<option value="No">No</option>
													<option value="Depends on Situation">Depends on Situation</option>
												</select>
											</div>
										</div>
										<div class="row">
											...
											<div class="col-6 form-group">
												...
												<select class="form-select chosen-select" name="read" required
										...
										<div class="row">
											<div class="col-6 form-group">
												...
												<select class="form-select chosen-select" name="movie[]" multiple
										...
										<div class="row">
											<div class="col-6 form-group">
												...
												<select class="form-select chosen-select" name="sport" required
													data-placeholder="Select*">
													<option value=""></option>
													<option value="Yes">Yes</option>
													<option value="No">No</option>
											...
											<div class="col-6 form-group">
												...
												<select class="form-select chosen-select" name="sportlik[]" multiple
													required data-placeholder="Select*">
													<option value=""></option>
									...
									<div class="edit-pro-parti">
										...
										<div class="row">
											<div class="col-6 form-group">
												...
												<select class="form-select chosen-select" name="eating" required
													data-placeholder="Select*">
													<option value=""></option>
										...
										<div class="row">
											<div class="col-md-6 form-group">
												<label class="lb">What kind of places do you like to travel?:</label>
												<input type="text" class="form-control"
													placeholder="e.g. Beaches, Mountains, Cities" name="travel"
													required>
											</div>
											<div class="col-md-6 form-group">
												<label class="lb">How much time you spend on social media:</label>
									...
									<div class="edit-pro-parti">
										...
										<div class="row">
											<div class="col-md-6 form-group">
												...
												<input type="text" class="form-control"
													placeholder="e.g. Father, Mother, Brother, Sister" name="family"
													required>
											</div>
											<div class="col-md-6 form-group">
												<label class="lb">How is your relationship with your parents?:</label>
												<input type="text" class="form-control"
										...
										<div class="row">
											<div class="col-md-6 form-group">
												<label class="lb">How much time do you spend with your family?:</label>
												<input type="text" class="form-control"
													placeholder="e.g., Daily, Weekends, Special Occasions"
													name="timefam" required>
											</div>
											<div class="col-md-6 form-group">
												<label class="lb">What activities do you do with your family?:</label>
										...
										<div class="row">
											...
											<div class="col-md-6 form-group">
												<label class="lb">What do you expect from your partner?:</label>
									...
									<div class="edit-pro-parti">
										...
										<div class="row">
											<div class="col-md-6 form-group">
												...
												<textarea
													...
													id="" class="form-control" name="goal" required></textarea>
											</div>
											<div class="col-md-6 form-group">
												<label class="lb">What kind of career do you want to pursue?:</label>
										...
										<div class="row">
											<div class="col-6 form-group">
												...
												<select class="form-select chosen-select" name="children" required
													data-placeholder="Select*">
													<option value=""></option>
													<option value="Yes">Yes</option>
													<option value="No">No</option>
										...
										<div class="row">
											<div class="col-md-6 form-group">
												<label class="lb">What are your views on parenting styles and raising
													children?:</label>
											...
											<div class="col-md-6 form-group">
												<label class="lb">How do you envision dividing household chores and
										...
										<div class="row">
											<div class="col-6 form-group">
												<label class="lb">Would you mind if your partner had to travel for their
													job?:</label>
												<select class="form-select chosen-select" name="traveljob" required
													data-placeholder="Select*">
													<option value=""></option>
													<option value="Yes">Yes</option>
													<option value="No">No</option>
											...
											<div class="col-6 form-group">
												<label class="lb">Would you mind if your partner had late meetings or
													night
													shifts?:</label>
												<select class="form-select chosen-select" name="shift" required
													data-placeholder="Select*">
													<option value=""></option>
													<option value="Yes">Yes</option>
													<option value="No">No</option>
	...
	<script>
		$(document).ready(function () {
			// Initialize Chosen
			$('#marital').chosen();
			$('#children_status').chosen();

			function toggleChildFields() {
				let status = $('#marital').val();

				if (status === 'Married' || status === 'Divorced' || status === 'Widowed') {
					// Show Total Children and Children Status fields
					$('#total_children_div, #children_status_div').show();
				} else {
					// Hide Total Children and Children Status fields
					$('#total_children_div, #children_status_div').hide();
				}
			}

			// Trigger on change
			$('#marital').on('change', toggleChildFields);
