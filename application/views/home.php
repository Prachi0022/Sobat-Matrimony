	...
	<div class="hom-ban-sli">
		<div>
			<ul class="ban-sli">
				<li>
					<div class="image">
						<img src="<?php echo base_url()?>assets/images/banner.jpg" alt="" loading="lazy">
					</div>
				</li>
			</ul>
		</div>
...
<section class="">
	<div class="str home-acces-main">
		<img src="<?php echo base_url()?>assets/images/leaf/tl.png" alt="decor" class="corner-img left-corner">
		<img src="<?php echo base_url()?>assets/images/leaf/rb.png" alt="decor" class="corner-img right-corner">
		<div class="container">
			<div class="row">
				<div class="home-tit">
					<p>Quick Access</p>
					...
					<ul class="hom-qui-acc-sli">
						<li>
							<div class="wow fadeInUp hacc hacc1" data-wow-delay="0.1s">
								<div class="con">
									<img src="<?php echo base_url()?>assets/images/icon/user.png" alt="" loading="lazy">
						...
						<li>
							<div class="wow fadeInUp hacc hacc3" data-wow-delay="0.3s">
								<div class="con">
									<img src="<?php echo base_url()?>assets/images/icon/couple.png" alt=""
										loading="lazy">
									<h4>All Services</h4>
									<p>1200+ Profiles</p>
									<a href="#!">View more</a>
						...
						<li>
							<div class="wow fadeInUp hacc hacc4" data-wow-delay="0.4s">
								<div class="con">
									<img src="<?php echo base_url()?>assets/images/icon/hall.png" alt="" loading="lazy">
									<h4>Join Now</h4>
									<p>Start for free</p>
						...
						<li>
							<div class="wow fadeInUp hacc hacc3" data-wow-delay="0.3s">
								<div class="con">
									<img src="<?php echo base_url()?>assets/images/icon/photo-camera.png" alt=""
										loading="lazy">
									<h4>Photo gallery</h4>
									<p>1200+ Profiles</p>
									<a href="#!">View more</a>
						...
						<li>
							<div class="wow fadeInUp hacc hacc4" data-wow-delay="0.4s">
								<div class="con">
									<img src="<?php echo base_url()?>assets/images/icon/cake.png" alt="" loading="lazy">
									<h4>Blog & Articles</h4>
									<p>Start for free</p>
									<a href="#!">Get started</a>
								</div>
					...
					<ul class="slider3">
						<li>
							<div class="cus-revi-box">
								<div class="revi-im">
									<img src="<?php echo base_url()?>assets/images/user/1.jpg" alt="" loading="lazy">
						...
						<li>
							<div class="cus-revi-box">
								<div class="revi-im">
									<img src="<?php echo base_url()?>assets/images/user/2.jpg" alt="" loading="lazy">
									<i class="cir-com cir-1"></i>
									<i class="cir-com cir-2"></i>
									<i class="cir-com cir-3"></i>
								</div>
						...
						<li>
							<div class="cus-revi-box">
								<div class="revi-im">
									<img src="<?php echo base_url()?>assets/images/user/3.jpg" alt="" loading="lazy">
									<i class="cir-com cir-1"></i>
									<i class="cir-com cir-2"></i>
									<i class="cir-com cir-3"></i>
								</div>
						...
						<li>
							<div class="cus-revi-box">
								<div class="revi-im">
									<img src="<?php echo base_url()?>assets/images/user/5.jpg" alt="" loading="lazy">
									<i class="cir-com cir-1"></i>
									<i class="cir-com cir-2"></i>
									<i class="cir-com cir-3"></i>
								</div>
...
<!-- BANNER -->
<section class="str home-acces-main pt--0">
	<img src="<?php echo base_url()?>assets/images/leaf/tl.png" alt="decor" class="corner-img left-corner">
	<img src="<?php echo base_url()?>assets/images/leaf/rb.png" alt="decor" class="corner-img right-corner">
	<div class="str">
		<div class="ban-inn">
...
<!-- START -->
<section class="str home-acces-main">
	<img src="<?php echo base_url()?>assets/images/leaf/tr.png" alt="decor" class="corner-img left-t-corner">
	<div class="ab-sec2">
				...
				<ul>
					<li>
						<div class="animate animate__animated animate__slower" data-ani="animate__flipInX"
							data-dely="0.1">
							<img src="<?php echo base_url()?>assets/images/icon/prize.png" alt="" loading="lazy">
					...
					<li>
						<div class="animate animate__animated animate__slower" data-ani="animate__flipInX"
							data-dely="0.3">
							<img src="<?php echo base_url()?>assets/images/icon/trust.png" alt="" loading="lazy">
							<h4>Most trusted</h4>
					...
					<li>
						<div class="animate animate__animated animate__slower" data-ani="animate__flipInX"
							data-dely="0.6">
							<img src="<?php echo base_url()?>assets/images/icon/rings.png" alt="" loading="lazy">
							<h4>2000+ weddings</h4>
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="ab-wel-lhs">
						...
						<img src="<?php echo base_url()?>assets/images/about/1.jpeg" alt="" loading="lazy"
							class="ab-wel-1">
						<img src="<?php echo base_url()?>assets/images/couples/20.jpeg" alt="" loading="lazy"
							class="ab-wel-2">
							...
							<ul>
								<li>
									<div>
										...
										<h4>Enquiry <em>+91 9967536799</em></h4>
									</div>
								</li>
								<li>
									<div>
										<i class="fa fa-envelope-o" aria-hidden="true"></i>
										<h4>Get Support <em>enquiry@sobatmatrimony.com</em></h4>
									</div>
								</li>
							</ul>
						</div>
...
<!-- MOMENTS START -->
<section>
	<div class="wedd-tline str home-acces-main">
		<img src="<?php echo base_url()?>assets/images/leaf/tl.png" alt="decor" class="corner-img left-corner">
		<img src="<?php echo base_url()?>assets/images/leaf/rb.png" alt="decor" class="corner-img right-corner">
		<div class="container">
			<div class="row">
					...
					<ul>
						<li>
							<div class="tline-inn">
								<div class="tline-im animate animate__animated animate__slower"
									...
									<img src="<?php echo base_url()?>assets/images/icon/rings.png" alt=""
										loading="lazy">
								</div>
						...
						<li>
							<div class="tline-inn tline-inn-reve">
								...
								<div class="tline-im animate animate__animated animate__slow"
									data-ani="animate__fadeInUp">
									<img src="<?php echo base_url()?>assets/images/icon/wedding-2.png" alt=""
										loading="lazy">
								</div>
							</div>
						</li>
						<li>
							<div class="tline-inn">
								<div class="tline-im animate animate__animated animate__slower"
									data-ani="animate__fadeInUp">
									<img src="<?php echo base_url()?>assets/images/icon/love-birds.png" alt=""
										loading="lazy">
								</div>
								<div class="tline-con animate animate__animated animate__slow"
									data-ani="animate__fadeInUp">
						...
						<li>
							<div class="tline-inn tline-inn-reve">
								...
								<div class="tline-im animate animate__animated animate__slow"
									data-ani="animate__fadeInUp">
									<img src="<?php echo base_url()?>assets/images/icon/network.png" alt=""
										loading="lazy">
								</div>
							</div>
						</li>
						<li>
							<div class="tline-inn">
								<div class="tline-im animate animate__animated animate__slower"
									data-ani="animate__fadeInUp">
									<img src="<?php echo base_url()?>assets/images/icon/chat.png" alt="" loading="lazy">
								</div>
								<div class="tline-con animate animate__animated animate__slow"
									data-ani="animate__fadeInUp">
									<h5>Start Meetups</h5>
						...
						<li>
							<div class="tline-inn tline-inn-reve">
								...
								<div class="tline-im animate animate__animated animate__slow"
									data-ani="animate__fadeInUp">
									<img src="<?php echo base_url()?>assets/images/icon/wedding-couple.png" alt=""
										loading="lazy">
								</div>
							</div>
						</li>
...
<!-- RECENT COUPLES -->
<section class="str home-acces-main">
	<div class="hom-couples-all cus-revi ">
		<div class="container">
			<div class="row">
				<div class="home-tit">
					<p>trusted brand</p>
			...
			<ul class="couple-sli">
				<li>
					<div class="hom-coup-box">
						...
						<img src="<?php echo base_url()?>assets/images/couples/6.jpg" alt="" loading="lazy">
						<div class="bx">
				...
				<li>
					<div class="hom-coup-box">
						<span class="leaf"></span>
						<img src="<?php echo base_url()?>assets/images/couples/7.jpg" alt="" loading="lazy">
						<div class="bx">
							<h4>Dany & July <span>New York</span></h4>
						</div>
					</div>
				...
				<li>
					<div class="hom-coup-box">
						<span class="leaf"></span>
						<img src="<?php echo base_url()?>assets/images/couples/8.jpg" alt="" loading="lazy">
						<div class="bx">
							<h4>Dany & July <span>New York</span></h4>
						</div>
					</div>
				...
				<li>
					<div class="hom-coup-box">
						<span class="leaf"></span>
						<img src="<?php echo base_url()?>assets/images/couples/10.jpg" alt="" loading="lazy">
						<div class="bx">
							<h4>Dany & July <span>New York</span></h4>
						</div>
					</div>
				...
				<li>
					<div class="hom-coup-box">
						<span class="leaf"></span>
						<img src="<?php echo base_url()?>assets/images/couples/3.jpg" alt="" loading="lazy">
						<div class="bx">
							<h4>Dany & July <span>New York</span></h4>
						</div>
					</div>
				...
				<li>
					<div class="hom-coup-box">
						<span class="leaf"></span>
						<img src="<?php echo base_url()?>assets/images/couples/4.jpg" alt="" loading="lazy">
						<div class="bx">
							<h4>Dany & July <span>New York</span></h4>
						</div>
					</div>
				...
				<li>
					<div class="hom-coup-box">
						<span class="leaf"></span>
						<img src="<?php echo base_url()?>assets/images/couples/5.jpg" alt="" loading="lazy">
						<div class="bx">
							<h4>Dany & July <span>New York</span></h4>
						</div>
					</div>
	...
	<div class="cta-full-wid">
		<a href="#!" class="cta-dark">View More</a>
	</div>
</section>
<!-- END -->
		...
		<div class="container">
			<div class="row">
				...
				<ul>
					...
					<li>
						<div>
							<img src="<?php echo base_url()?>assets/images/profiles/7.jpg" alt="" loading="lazy">
							<h4>Ashley Jen</h4>
							<p>Marketing Manager</p>
							<ul class="social-light">
								<li><a href="#!"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
					...
					<li>
						<div>
							<img src="<?php echo base_url()?>assets/images/profiles/8.jpg" alt="" loading="lazy">
							<h4>Emily Arrov</h4>
					...
					<li>
						<div>
							<img src="<?php echo base_url()?>assets/images/profiles/9.jpg" alt="" loading="lazy">
							<h4>Julia sear</h4>
						...
						<li>
							<div class="blog-box">
								...
								<p>It is a long established fact that a reader will be distracted by the readable
									content.</p>
								<a href="#!" class="cta-dark"><span>Read more</span></a>
							</div>
						</li>
						<li>
							<div class="blog-box">
