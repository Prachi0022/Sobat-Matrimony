						...
						<ul class="slider">
							<li>
								<div class="db-new-pro">
									<img src="<?php echo base_url()?>assets/images/profiles/16.jpg" alt=""
										class="profile">
									<div>
										<h5>Julia ann</h5>
									...
									<a href="<?php echo base_url()?>profile-detail" class="fclick" target="_blank">&nbsp;</a>
								</div>
							</li>
							<li>
								<div class="db-new-pro">
									<img src="<?php echo base_url()?>assets/images/profiles/2.jpg" alt=""
										class="profile">
									<div>
										<h5>Julia ann</h5>
										<span class="city">New york</span>
							...
							<li>
								<div class="db-new-pro">
									<img src="<?php echo base_url()?>assets/images/profiles/3.jpg" alt=""
										class="profile">
									<div>
										<h5>Julia ann</h5>
										<span class="city">New york</span>
							...
							<li>
								<div class="db-new-pro">
									<img src="<?php echo base_url()?>assets/images/profiles/5.jpeg" alt=""
										class="profile">
									<div>
										<h5>Julia ann</h5>
										<span class="city">New york</span>
							...
							<li>
								<div class="db-new-pro">
									<img src="<?php echo base_url()?>assets/images/profiles/6.jpg" alt=""
										class="profile">
									<div>
										<h5>Julia ann</h5>
										<span class="city">New york</span>
							...
							<li>
								<div class="db-new-pro">
									<img src="<?php echo base_url()?>assets/images/profiles/14.jpg" alt=""
										class="profile">
									<div>
										<h5>Julia ann</h5>
										<span class="city">New york</span>
					...
					<div class="row">
						<div class="col-md-12 col-lg-6 col-xl-4 db-sec-com">
							...
							<div class="db-profile">
								<div class="img">
									<img src="<?php echo base_url()?>assets/images/profiles/12.jpg" loading="lazy" alt="">
								</div>
								<div class="edit">
									<a href="<?php echo base_url()?>basicinfo" class="cta-dark" target="_blank">Edit profile</a>
								</div>
							</div>
						</div>
						<div class="col-md-12 col-lg-6 col-xl-4 db-sec-com">
									...
									<ul>
										<li>
											<div class="db-int-pro-1"> <img
													src="<?php echo base_url()?>assets/images/profiles/2.jpg" alt="">
											</div>
										...
										<li>
											<div class="db-int-pro-1"> <img
													src="<?php echo base_url()?>assets/images/profiles/16.jpg" alt="">
											</div>
											<div class="db-int-pro-2">
												<h5>Julia Ann</h5> <span>Illunois, United States</span>
											</div>
										...
										<li>
											<div class="db-int-pro-1"> <img
													src="<?php echo base_url()?>assets/images/profiles/13.jpg" alt="">
											</div>
											<div class="db-int-pro-2">
												<h5>Julia Ann</h5> <span>Illunois, United States</span>
											</div>
										...
										<li>
											<div class="db-int-pro-1"> <img
													src="<?php echo base_url()?>assets/images/profiles/14.jpg" alt="">
											</div>
											<div class="db-int-pro-2">
												<h5>Julia Ann</h5> <span>Illunois, United States</span>
											</div>
							...
							<div class="db-pro-stat">
								<div class="db-inte-main">
									...
									<ul class="nav nav-tabs" role="tablist">
										...
										<li class="nav-item">
											<a class="nav-link" data-bs-toggle="tab" href="#menu3">Shortlisted</a>
										</li>
									</ul>
									<!-- Tab panes -->
									<!-- Tab panes -->
