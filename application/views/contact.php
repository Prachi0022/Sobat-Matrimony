				...
				<ul>
					<li>
						<div class="we-here">
							<h3>Our office</h3>
							<p>Most Trusted and premium Matrimony Service in the World.</p>
							<span><i class="fa fa-phone" aria-hidden="true"></i> <a href="tel:+91 9967536799">+91 9967536799</a> </span>
							<span><i class="fa fa-envelope-o" aria-hidden="true"></i> <a href="mailto:enquiry@sobatmatrimony.com">enquiry@sobatmatrimony.com</a></span>
							<span><i class="fa fa-map-marker" aria-hidden="true"></i>Sobat Vivah Sanstha, 607, 6th floor, Pujit Plaza, sector-11, CBD Belapur, navi mumbai</span>
						</div>
					</li>
					<li>
						<div class="we-cont">
							<img src="<?php echo base_url()?>assets/images/icon/trust.png" alt="">
					...
					<li>
						<div class="we-cont">
							<img src="<?php echo base_url()?>assets/images/icon/telephone.png" alt="">
