            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="inn">
                        <div class="lhs">
                            <div class="tit">
                                <h2>Now <b>Partner with Us to Grow Your Business</b></h2>
                                <h3>
                                     Register as a verified vendor and connect with genuine clients looking for trusted wedding services.
                                </h3>
                            </div>
                        </div>
                        <div class="rhs">
                            <div>
                                <div class="form-tit">
                                    ...
                                    <h1>Become a Trusted Vendor with Matrimony</h1>
                                    <p>Already a member? <a href="<?php echo base_url()?>vendor-login">Login</a></p>
                                </div>
