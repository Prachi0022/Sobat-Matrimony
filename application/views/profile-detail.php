				...
				<div class="profi-pg profi-bio">
					<div class="lhs">
						...
						<div class="pr-bio-c pr-bio-conta">
							<h3>Contact info</h3>
							<ul>
								<li><span><i class="fa fa-mobile" aria-hidden="true"></i><b>Phone:</b>+92 (8800) 68
										- 8960</span></li>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body seninter">
				<div class="lhs">
					<img src="<?php echo base_url()?>assets/images/profiles/1.jpg" alt="" class="intephoto1">
				</div>
				<div class="rhs">
...
<div class="chatbox">
	...
	<div class="inn">
		<form name="new_chat_form" method="post">
			<div class="s1">
				<img src="<?php echo base_url()?>assets/images/profiles/2.jpg" class="intephoto2" alt="">
