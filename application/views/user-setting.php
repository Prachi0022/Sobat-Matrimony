						...
						<div class="col-md-12 db-sec-com">
							...
							<div class="col7 fol-set-rhs">
									...
									<div class="fol-sett-box">
										<ul>
											<li>
												<div class="sett-lef">
													<div class="auth-pro-sm sett-pro-wid">
														<div class="auth-pro-sm-img">
															<img src="<?php echo base_url()?>assets/images/profiles/15.jpg" alt="">
														</div>
												...
												<div class="sett-rig">
													<a href="<?php echo base_url()?>login" class="set-sig-out">Sign Out</a>
												</div>
											</li>
											<li>
												<div class="sett-lef">
												...
												<div class="sett-rig">
													<div class="sett-select-drop">
														<select>
															...
															<option value="Free">No-more visible(You can't visible, so
																no one can view your profile)</option>
														</select>
													</div>
												</div>
											</li>
											<li>
												<div class="sett-lef">
													<div class="sett-rad-left">
														...
														<p>You can set-up who can able to make Interest request here.
														</p>
													</div>
												</div>
												<div class="sett-rig">
								...
								<div class="ms-write-post fol-sett-sec sett-rhs-acc" style="">
									<div class="foll-set-tit fol-pro-abo-ico">
										<h4>Account</h4><a href="#!" class="sett-edit-btn sett-acc-edit-eve"><i
										...
										<form class="form-com sett-pro-form">
											<ul>
												...
												<li>
													...
													<div class="fm-fie"><input type="text" value="vijaykumar@gmail.com">
													</div>
												</li>
												<li>
												...
												<li><input type="submit" value="Update" class="sett-acc-edi-can">
												<input type="reset" value="Cancel" class="sett-acc-edi-can"></li>
											</ul>
									...
									<div class="fol-sett-box">
										<ul>
											<li>
												...
												<div class="sett-rig">
													<div class="checkboxes-and-radios">
														<input type="checkbox" name="checkbox-cats" id="sett-not-mail"
															value="1" checked="">
											...
											<li>
												...
												<div class="sett-rig">
													<div class="checkboxes-and-radios">
														<input type="checkbox" name="checkbox-cats" id="sett-not-mes"
															value="1" checked="">
